...
class Nav extends Component {
    renderAuthButtons = () => {
        ...
        if (auth) {
            return <button className="button red darken-2" onClick={userSignOut}>Sign Out</button>
        }

        return <button className="button green darken-2" onClick={userSignIn}>Sign In</button>
    }
